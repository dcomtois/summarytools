...
#### Tips for the Four Core Functions  
- [freq()](#freq)  
- [ctable()](#ctable)    
- [descr()](#descr)  
- [dfSummary()](#dfsummary)  
...
- [Using Other Formatting Packages](#packages)  
- [Including dfSummaries in PDF documents](#dfspdf)  
- [This vignette's setup](#vignSetup)  
...
## Rmarkdown Style for freq()
```{r}
freq(tobacco$gender, style = 'rmarkdown')
```


## HTML Rendering for freq()
```{r}
...
## Rmarkdown Style for descr()
```{r}
descr(tobacco, style = 'rmarkdown')
```

## HTML Rendering for descr()
...
## <a id="packages"></a>Using Other Formatting Packages
...
## <a id="dfspdf"></a>Including dfSummaries in pdf documents
...
## <a id="vignSetup"></a>This Vignette's Setup
