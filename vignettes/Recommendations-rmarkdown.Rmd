...
There is no way to directly generate a *pdf*, but it is easy to convert an
*html* document to that format. Refer the introductory vignette for detailed
instructions.
...
_pdf_ document, you might want to try different combinations of options. Note that
the _rendering_ method is not well-suited for _Word_ documents.