...
outputs produced by **summarytools** can be:
  ...
  - Written to _html_ files that fire up in
    [*RStudio*](https://www.rstudio.com/)’s Viewer pane or in your default
    browser
...
Versions 0.8.9 (which was released only on [GitHub](https://github.com/dcomtois/summarytools/releases))
and 0.9.0 brought _many_ changes and improvements to **summarytools**. This 
[vignette](library/summarytools/doc/New-in-Version-0-9.html) 
