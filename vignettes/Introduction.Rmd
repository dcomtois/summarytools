...
<table><tr><td>![](assets/lightbulb.svg)</td>
<td>Using pipes makes it easier to generate `ctable()` results.</td></tr></table>
...
will be shown in the data viewer. Also, be mindful of the order in which
...
than Pandoc with `dfSummary()` output). 
