...
tools such as RStudio's for [rmarkdown](http://rmarkdown.rstudio.com/), and [knitr](https://yihui.name/knitr/).
...
It is also possible to include **summarytools**' functions in *shiny apps*. Notably, 
...
an in-depth view of those changes, but here are the key points:
 ...
 - Translations
   ...
   + An additional function, `useTranslations()` allows using a custom translations
     _csv_ file; a template is available 
 ...
 - Improved printing of list objects
   + Object of class "by" are now printed in the console with optimal results;
...
using RStudio:
![Example of dfSummary Output displayed in RStudio's viewer](dfSummary_in_RStudio_Viewer.png)
