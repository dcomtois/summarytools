...
using *PDF* as the output format, but with a caveat: displaying \emph{png} graphs
with `dfSummary()` will cause vertical misalignment. We certainly hope to be able
resolve this issue in a future version; in the meantime, using the text graphs
is still a viable option, if you don't mind a little bit of \emph{ascii art}! To
achieve this, simply omit the \emph{tmp.img.dir} argument.
...
Calling this function without any arguments will
