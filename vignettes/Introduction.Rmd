...
changes can be found [at the end of this vignette](#changes).

#### This Document's Setup
...
Here's what the setup chunk looks like:
...
opts_chunk$set(comment = NA, prompt = FALSE, cache = FALSE, results = 'asis')
library(summarytools)
st_options(plain.ascii = FALSE,       # This is an absolute must
           style = "rmarkdown",       # This too
           footnote = NA,             # Producing footnotes would clutter the results
...
```{r, echo=FALSE}
st_css()    # This is also a must; without it, you can expect odd layout.
```
````
<br/>
