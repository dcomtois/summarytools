...
[document-vignette](https://TODO) gives
a detailed description of those changes, but a summary can be found [at the end of
...
<img src="ctable-with-row-props.png" style="border:0;align=center;" width=70% />
...
using RStudio:
<img src="dfSummary_in_RStudio_Viewer.png" width=100% border=0/>
...
# ```
````
![Example of rendered output](dfSummary-render-in-markdown.png)
