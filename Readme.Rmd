...
copy the template and turn it into a new set of translations, and do a pull request!
If you don't have a GitHub account (and don't want to become one, even though it's
