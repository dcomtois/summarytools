...
turn the template into a new set of translations, and do a pull request if you
have a GitHub account. If you don't, just send me an email (see bottom of this
page). Danke in advance! :)
