...
It is now possible to switch the language used in the outputs. So far, the following languages are available: French (fr), Spanish (es), Portuguese (pt), and Turkish (tr). With 
the community's involvement, I hope we can gather a lot more.
