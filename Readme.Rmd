...
After doing so, it even allows 
exporting the resulting "custom language" into a _csv_ file that can be 
imported later on with `use_custom_lang()`. It is also possible to define 
one or several keywords using arguments. For instance:
