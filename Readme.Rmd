...
For a middle-ground solution, you can install this inbetween version, although
I don't see much benefit, to be honest. Version 0.9.0 has been much more
thoroughly tested and has many advantages over 0.8.9. But still, if you wish
...
Note that I do not intend to push this version to CRAN, mainly because I lack
the time to create extensive documentation for both 0.8.9 and 0.9.0.
